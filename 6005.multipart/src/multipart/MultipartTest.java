...
public class MultipartTest {
	...
	@Test public void emptyFile() throws IOException {
		InputStream in = Multipart.openStream("http://mit.edu/6.005/www/fa10/project1/empty.txt");
	...
	@Test public void emptyPartsFile() throws IOException {
		...
		InputStream in = Multipart.openStream("http://mit.edu/6.005/www/fa10/project1/empty.txt.parts");
